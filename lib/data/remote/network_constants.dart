...
class NetworkConstants {
  static const BASE_URL = "https://praxisal.aprexi.com";

  static const LIST_OFFER_COMPANY = "$BASE_URL/ListOfferCompany.php";
  static const OFFER_COMPANY = "$BASE_URL/OfferCompany.php";
  static const COMPANY = "$BASE_URL/Company.php";
